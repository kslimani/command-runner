...
AsyncRunner.prototype._setTrap = function() {
  ...
  process.on('exit', this._signalHandler.bind(this, {cleanup: true}))
  process.on('SIGINT', this._signalHandler.bind(this, {exit: true}))
  process.on('SIGTERM', this._signalHandler.bind(this, {exit: true}))
  process.on('uncaughtException', this._signalHandler.bind(this, {exit: true}))
}
